  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        <IonCard>
          <IonCardHeader>
            <IonCardTitle>Registro de Enfermero</IonCardTitle>
          </IonCardHeader>
          <IonItem>
          ...
          <IonItem>
            <IonLabel position="floating">TurnoAsignado</IonLabel>
            <IonInput name="TurnoAsignado" value={form.TurnoAsignado} onIonChange={handleChange} />
          </IonItem>
          <IonItem>
            <IonLabel position="floating">AreaDeAtencion</IonLabel>
            <IonInput name="AreaDeAtencion" value={form.AreaDeAtencion} onIonChange={handleChange} />
          </IonItem>
